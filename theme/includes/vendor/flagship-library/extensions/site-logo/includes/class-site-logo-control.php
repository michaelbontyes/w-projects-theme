...
class Flagship_Site_Logo_Image_Control extends WP_Customize_Control {
	...
	public function __construct( $wp_customize, $control_id, $args = array() ) {
		...
		$this->l10n = array(
			'upload'      => __( 'Add logo',    'woodd' ),
			'set'         => __( 'Set as logo', 'woodd' ),
			'choose'      => __( 'Choose logo', 'woodd' ),
			'change'      => __( 'Change logo', 'woodd' ),
			'remove'      => __( 'Remove logo', 'woodd' ),
			'placeholder' => __( 'No logo set', 'woodd' ),
		);
