...
add_action( 'admin_init', 'woodd_add_editor_styles' );
/**
 ...
 * @return void
 */
function woodd_add_editor_styles() {
...
add_action( 'wp_enqueue_scripts', 'woodd_rtl_add_data' );
/**
 * Replace the default theme stylesheet with a RTL version when a RTL
 * language is being used.
 *
 ...
 * @return void
 */
function woodd_rtl_add_data() {
	wp_style_add_data( 'style', 'rtl', 'replace' );
	wp_style_add_data( 'style', 'suffix', hybrid_get_min_suffix() );
}

add_action( 'wp_enqueue_scripts', 'woodd_enqueue_styles', 4 );
/**
...
add_action( 'wp_enqueue_scripts', 'woodd_enqueue_scripts' );
/**
 ...
 * @return void
 */
function woodd_enqueue_scripts() {
