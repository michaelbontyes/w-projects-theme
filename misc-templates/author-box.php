		...
		<ul class="social-icons clearfix">
			...
			<li class="social-twitter">
				<a href="<?php echo esc_url( 'https://twitter.com/' . get_the_author_meta( 'twitter' ) ); ?>">
					<span class="text"><?php esc_attr_e( 'Twitter', 'woodd' ); ?></span>
				</a>
			</li>
			<?php endif; ?>
			...
			<li class="social-gplus">
				<a href="<?php the_author_meta( 'googleplus' ); ?>">
					<span class="text"><?php esc_attr_e( 'Google+', 'woodd' ); ?></span>
				</a>
			</li>
			<?php endif; ?>
			...
			<li class="social-facebook">
				<a href="<?php echo the_author_meta( 'facebook' ); ?>">
					<span class="text"><?php esc_attr_e( 'Facebook', 'woodd' ); ?></span>
				</a>
			</li>
			<?php endif; ?>
			...
			<li class="social-rss">
				<a href="<?php echo esc_url( get_author_feed_link( get_the_author_meta( 'ID' ) ) ); ?>">
					<span class="text"><?php esc_attr_e( 'RSS Feed', 'woodd' ); ?></span>
				</a>
			</li>
