...
class Flagship_Search_Form {
	...
	protected function get_label() {
		$label = apply_filters( 'flagship_search_form_label', __( 'Search site', 'woodd' ) );
	...
	protected function get_input() {
		...
		$placeholder = apply_filters( 'flagship_search_text', __( 'Search this website', 'woodd' ) );
	...
	protected function get_button() {
		return sprintf(
			...
			esc_attr( apply_filters( 'flagship_search_button_label', __( 'Search', 'woodd' ) ) ),
			esc_attr( apply_filters( 'flagship_search_button_text', __( 'Search', 'woodd' ) ) )
		);
	}
